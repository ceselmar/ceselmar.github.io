...
//	createNewPropertyTemplate(os, "FDA_Test3", "INTEGER", Cardinality.SINGLE, "FDA Test 3");
	...
	createNewPropertyTemplate(os, "FDA_Test5", "STRING", Cardinality.SINGLE, "FDA Test 5");
	createNewPropertyTemplate(os, "FDA_Test6", "STRING", Cardinality.SINGLE, "FDA Test 6");
	createNewPropertyTemplate(os, "FDA_Test7", "INTEGER", Cardinality.SINGLE, "FDA Test 7");
//
